...
(require
 ...
 (test-case "patch 6 - simple jump-if"
  ...
  (test-case "patch 6 - public 1"
   ...
   (test-case "patch 6 - public 2"
   (check-equal?
(patch-instructions 
   '(begin (with-label L.__main.98 (set! r15 r15)) (set! rdi 5) (set! r15 r15) (jump L.fact.7) (with-label L.identity.6 (set! (rbp - 0) r15)) (set! r15 rdi) (compare r15 0) (jump-if = L.__nested.96) (jump L.__nested.97) (with-label L.__nested.96 (set! rax 0)) (jump (rbp - 0)) (with-label L.__nested.97 (set! r15 r15)) (set! r15 (- r15 1)) (set! rbp (- rbp 8)) (set! rdi r15) (set! r15 L.rp.14) (jump L.identity.6) (with-label L.rp.14 (set! rbp (+ rbp 8))) (set! r15 rax) (set! rax 1) (set! rax (+ rax r15)) (jump (rbp - 0)) (with-label L.fact.7 (set! (rbp - 0) r15)) (set! r15 rdi) (set! rbp (- rbp 16)) (set! rdi r15) (set! r15 L.rp.15) (jump L.identity.6) (with-label L.rp.15 (set! rbp (+ rbp 16))) (set! (rbp - 8) rax) (set! rbp (- rbp 16)) (set! rdi 0) (set! r15 L.rp.16) (jump L.identity.6) (with-label L.rp.16 (set! rbp (+ rbp 16))) (set! r15 rax) (compare (rbp - 8) r15) (jump-if = L.__nested.94) (jump L.__nested.95) (with-label L.__nested.94 (set! rbp (- rbp 16))) (set! rdi 1) (set! r15 L.rp.17) (jump L.identity.6) (with-label L.__nested.95 (set! rbp (- rbp 16))) (set! rdi 1) (set! r15 L.rp.18) (jump L.identity.6) (with-label L.rp.18 (set! rbp (+ rbp 16))) (set! r14 rax) (set! r15 (rbp - 8)) (set! r15 (- r15 r14)) (set! rbp (- rbp 16)) (set! rdi r15) (set! r15 L.rp.19) (jump L.fact.7) (with-label L.rp.19 (set! rbp (+ rbp 16))) (set! r15 rax) (set! rax (rbp - 8)) (set! rax (* rax r15)) (jump (rbp - 0)) (with-label L.rp.17 (set! rbp (+ rbp 16))) (set! r15 rax) (set! rax r15) (jump (rbp - 0))))
      '(begin
